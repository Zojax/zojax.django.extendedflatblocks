...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'FlatBlockExtension', fields ['flatblock']
        db.delete_unique('extendedflatblocks_flatblockextension', ['flatblock_id'])
    
    
    def backwards(self, orm):
        
        # Changing field 'FlatBlockExtension.flatblock'
        db.alter_column('extendedflatblocks_flatblockextension', 'flatblock_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['flatblocks.FlatBlock']))

        # Adding unique constraint on 'FlatBlockExtension', fields ['flatblock']
        db.create_unique('extendedflatblocks_flatblockextension', ['flatblock_id'])
